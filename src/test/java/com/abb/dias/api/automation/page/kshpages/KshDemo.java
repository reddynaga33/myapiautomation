 ...
 * com.abb.dias.api.automtion.core.jsonreader.JsonReader; import
 ...
 * 
 * 
 * //static ExtentTest test; //static ExtentReports report;
 * 
 * @BeforeClass public static void startTest() { report = new
 * ExtentReports(System.getProperty("user.dir")+"\\ExtentReportResults.html");
 * //test = report.startTest("KSH API Services Run"
 * ,"This tet run all the ksh api services");
 * 
 * } //@Test
 * 
 ...
 * 
 * @AfterClass public static void endTest() { report.endTest(test);
 * report.flush(); }
 * 
 * 
 * 
 ...
 * 
 * 
 * @SuppressWarnings("static-access") public void executeKshApisService() {
 * TestLogger.testMessage("eys"); Response response = null; JSONObject json =
 * null; int number_of_testcases=0;
 * 
 ...
 * 
 * 
 * try { NotepadWriter.deleteResultfolder();
 * 
 ...
 * +" AND Testcase id is: "+id.tc_id.get(j)+"  Repetation Number: "
 * +counter_repeatation); ExtentReport.geTestObj().log(Status.PASS,
 * id.api_name1.get(j) + " Respone code is  :" +
 ...
 * 
 * 
 * } else { ExtentReport.geTestObj().log(Status.INFO,
 * "The S.No of test case executed is :"+id.s_no_column.get(j)
 * +" AND Testcase id is: "+id.tc_id.get(j)+"Repetation Number is:"
 * +counter_repeatation); ExtentReport.geTestObj().log(Status.FAIL,
 * id.api_name1.get(j) + " Respone code is  :" +
 * response.getStatusCode()+" VS Expected Response code is :"+id.
 * expected_response_code.get(j)); number_of_ResponseCode_failed_testcases++;
 * 
 * }
 * 
 ...
 * 
 * //ExtentReport.geTestObj().log(Status.
 * PASS,"Content of the both files are equal : "+id.api_name1.get(j)+"_s.no"+id.
 * s_no_column.get(j)+"_repeation_No"+counter_repeatation+" VS "+
 * id.api_name1.get(j)+"_s.no"+id.s_no_column.get(j)+"_repeation_No"+
 * counter_repeatation);
 * 
 * number_of_contentEquals_passed_testcases++; } else {
 * 
 * //ExtentReport.geTestObj().log(Status.
 * FAIL,"Content of the both files are not equal : "+id.api_name1.get(j)+"_s.no"
 * +id.s_no_column.get(j)+"_repeation_No"+counter_repeatation+" VS "+
 * id.api_name1.get(j)+"_s.no"+id.s_no_column.get(j)+"_repeation_No"+
 * counter_repeatation);
 * 
 ...
 * }
 * 
 * else { ExtentReport.geTestObj().log(Status.FAIL,
 ...
 * TestLogger.errorMessage("An exception occured while run the kshapi service: "
 * + e.getMessage());
 * 
 * }
 * 
 ...
 * 
 * 
 * if(number_of_ResponseCode_failed_testcases<=
 * number_of_contentNotEquals_passed_testcases) {
 * ExtentReport.startTest(" Test Run status");
 * ExtentReport.NumberOfPassedTetCases("Number of testcases Run:: "
 * +number_of_testcases);
 * ExtentReport.NumberOfPassedTetCases("Number of Tetcases passed :: "
 * +(number_of_testcases-number_of_contentNotEquals_passed_testcases));
 * ExtentReport.NumberOfPassedTetCases("Number of Tetcases Failed :: "
 * +number_of_contentNotEquals_passed_testcases);
 * 
 * 
 * } else { ExtentReport.startTest(" Test Run status");
 * ExtentReport.NumberOfPassedTetCases("Number of testcases Run:: "
 * +number_of_testcases);
 * ExtentReport.NumberOfPassedTetCases("Number of Tetcases passed :: "
 * +(number_of_testcases-number_of_ResponseCode_failed_testcases));
 * ExtentReport.NumberOfPassedTetCases("Number of Tetcases Failed :: "
 ...
 * 
 * ExtentReport.NumberOfPassedTetCases("Number of testcases Run::- "
 * +number_of_testcases); ExtentReport.
 * NumberOfPassedTetCases("Number of Response Code passed Testcases::- "
 * +number_of_ResponseCode_passed_testcases); ExtentReport.
 * NumberOfFailedTetCases("Number of Response Code failed Testcases::- "
 * +number_of_ResponseCode_failed_testcases); ExtentReport.
 * NumberOfPassedTetCases("Number of content Matched passed Testcases::- "
 * +number_of_contentEquals_passed_testcases); ExtentReport.
 * NumberOfFailedTetCases("Number of content Mismatched Failed testcases::- "
 * +number_of_contentNotEquals_passed_testcases);
 * 
 * 
 * 
 ...
 * "An exception occured while extracting field values: "+ e.getMessage());
 * TestLogger.
 * errorMessage("An exception occured while extracting field values: "+
 * e.getMessage());
 * 
 * } }
 * 
 ...
 * = null; List<String> l = new ArrayList<String>(); for (int b = 0; b <
 * jsonitem.length; b++) { itemvalue = jsonitem[b].substring(1,
 * jsonitem[b].length() - 1); itemvalue2 = itemvalue.split(","); for (int c = 0;
 * c < itemvalue2.length; c++) { l.add(itemvalue2[c]); } } sortedList =
 * l.stream().sorted().collect(Collectors.toList()); } catch (Exception e) {
 * 
 * String nameofCurrMethod = new Throwable().getStackTrace()[0].getMethodName();
 * //ExtentReport.geTestObj().log(Status.INFO, //
 * "An exception occured in Method Nameis : " + nameofCurrMethod);
 ...
 * errorMessage("An exception occured while converting the api json response into key and values pairs: "
 * + e.getMessage());
 * 
 * 
 * 
 ...
 * 
 * 
 * This method is used to perform the meta file end point concatenation with
 * input data file end value
 * 
 ...
 * executeKshApisServiceS(ExtentTest test, ExtentReports report) { public void
 * executeKshApisServiceS() throws InterruptedException {
 * 
 ...
 * int number_of_contentNotEquals_passed_testcases=0;
 * 
 * TestLogger.testMessage("executekshApiservicees has started"); try {
 ...
 * 
 * if(id.meta_api_name.get(i).equals(id.api_name1.get(j))&(id.execute.get(j).
 * equalsIgnoreCase("yes"))) { //test =
 * report.startTest(id.meta_api_name.get(i)); int counter_repeatation=1;
 * 
 * for(int
 * repeation=1;repeation<=Integer.parseInt(id.no_of_repeatations.get(j));
 * repeation++) {
 ...
 * +counter_repeatation);
 * 
 * //ExtentReport.startTest("The S.No of test case executed is :"+id.s_no_column
 * .get(j)+" &  Testcase id is: "+id.tc_id.get(j)+" &  Number of repetation "
 * +counter_repeatation);
 * 
 ...
 * 
 * //
 * ExtentReport.getExtentObj().createTest("The S.No of test case executed is :"
 ...
 * 
 * // test =
 * ExtentsReport.getReportObj().startTest("The S.No of test case executed is :"
 * +id.s_no_column.get(j)+" &  Testcase id is: "+id.tc_id.get(j)
 * +" &  Number of repetation "+counter_repeatation);
 * 
 * //test =
 * report.startTest("The S.No of test case executed is :"+id.s_no_column.get(j)
 * +" &  Testcase id is: "+id.tc_id.get(j)+" &  Number of repetation "
 * +counter_repeatation);
 * //TestLogger.testMessage("The S.No of test case  executed is :"+id.
 * s_no_column.get(j)+" &  Testcase id is: "+id.tc_id.get(j)
 * +" &  Number of repetation "+counter_repeatation);
 * 
 * 
 ...
 * 
 * 
 * //ExtentReport.TestInfo("The S.No of test case executed is :"+id.s_no_column.
 * get(j)+" &  Testcase id is: "+id.tc_id.get(j)+" &  Number of repetation "
 * +counter_repeatation); // ExtentReport.TetPassedMesage( //id.api_name1.get(j)
 * + " Respone code is  :" +
 * response.getStatusCode()+" VS Expected Response code is :"+id.
 * expected_response_code.get(j));
 * 
 ...
 * //"The S.No of test case executed is :"+id.s_no_column.get(j)
 * +" &  Testcase id is: "+id.tc_id.get(j)+" &  Number of repetation "
 * +counter_repeatation); //test.log(LogStatus.PASS, // id.api_name1.get(j) +
 * " Respone code is  :" +
 * response.getStatusCode()+" VS Expected Response code is :"+id.
 * expected_response_code.get(j));
 * 
 ...
 * +counter_repeatation);
 * 
 * //ExtentReport.TetFail(id.api_name1.get(j) + " Respone code is  :" +
 * response.getStatusCode()+" VS Expected Response code is :"+id.
 * expected_response_code.get(j)+
 * " &  Content of the API Response and DB Response both files are mismatched : "
 * +id.api_name1.get(j)+"_s.no"+id.s_no_column.get(j)+"_repeation_No"+
 ...
 * +counter_repeatation);
 * 
 * // test.log(LogStatus.FAIL,id.api_name1.get(j) + " Respone code is  :" +
 * response.getStatusCode()+" VS Expected Response code is :"+id.
 * expected_response_code.get(j)+
 * " &  Content of the API Response and DB Response both files are mismatched : "
 * +id.api_name1.get(j)+"_s.no"+id.s_no_column.get(j)+"_repeation_No"+
 ...
 * +counter_repeatation);
 * 
 * //ExtentReport.geTestObj().log(Status.FAIL,id.api_name1.get(j) +
 * " Respone code is  :" +
 * response.getStatusCode()+" VS Expected Response code is :"+id.
 * expected_response_code.get(j)+
 * " &  Content of the API Response and DB Response both files are mismatched : "
 ...
 * "The S.No of test case executed is :"+id.s_no_column.get(j)
 * +" & Testcase id is: "+id.tc_id.get(j)+" & Number of repetation: "
 * +counter_repeatation); // ExtentReport.TetFail( // id.api_name1.get(j) +
 * " Respone code is  :" +
 * response.getStatusCode()+" VS Expected Response code is :"+id.
 * expected_response_code.get(j));
 * 
 ...
 * "The S.No of test case executed is :"+id.s_no_column.get(j)
 * +" & Testcase id is: "+id.tc_id.get(j)+" & Number of repetation: "
 * +counter_repeatation); // test.log(LogStatus.FAIL, // id.api_name1.get(j) +
 * " Respone code is  :" +
 * response.getStatusCode()+" VS Expected Response code is :"+id.
 * expected_response_code.get(j));
 * 
 ...
 * counter_repeatation+" VS "+
 * id.api_name1.get(j)+"_s.no"+id.s_no_column.get(j)+"_repeation_No"+
 * counter_repeatation); number_of_contentEquals_passed_testcases++;
 * 
 * 
 * 
 * 
 ...
 * }
 * 
 * else { //test.log(LogStatus.WARNING,
 * //"The api response key value pairs count is not machting with the db result key value pairs"
 * ); ExtentsReport.
 ...
 * 
 * String nameofCurrMethod = new Throwable().getStackTrace()[0].getMethodName();
 * ExtentsReport.testInfo( "An exception occured in Method Nameis : " +
 * nameofCurrMethod); //test.log(LogStatus.ERROR, //
 * "An exception occured while run the kshapi service: " + e.getMessage());
 * ExtentsReport.testError("An exception occured while run the kshapi service: "
 * + e.getMessage());
 * 
 * TestLogger.errorMessage("An exception occured while run the kshapi service: "
 * + e.getMessage());
 ...
 * ExtentReport.PrintInfo("Number of passed Testcases: " +
 * number_of_passed_testcases);
 * ExtentReport.PrintInfo("Number of Failed  Testcases: " +
 * (number_of_testcases-number_of_passed_testcases));
 * ExtentReport.PrintInfo("Number of Response Code passed Testcases: "
 * +number_of_ResponseCode_passed_testcases);
 * ExtentReport.PrintInfo("Number of Response Code failed testcases: "
 * +number_of_ResponseCode_failed_testcases); ExtentReport.
 * PrintInfo("Number of Response code and content matched  passed Testcases: "
 * +number_of_contentEquals_passed_testcases);
 * ExtentReport.PrintInfo("Number of content mismatched Failed Testcases: "
 * +number_of_contentNotEquals_passed_testcases);
 * 
 * 
 * } }
 ...
 * + e.getMessage()); TestLogger.
 * errorMessage("An exception occured while meta data endpoint concatnation with input Endpoint value: "
 * + e.getMessage());
 * 
 * 
 * 
