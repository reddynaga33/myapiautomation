...
public class FileComparisonHighlighter {
	...
	public static void compareFiles(String fileOne, String fileTwo) {
		...
		try {
            ...
            TestLogger.errorMessage(" Method Name is : " + nameofCurrMethod
					+ " ,An exception occured while reading the line by line in text file1: " + e.getMessage());
		...
		try {
			...
			String nameofCurrMethod = new Throwable().getStackTrace()[0].getMethodName();
			 ...
			 TestLogger.errorMessage(" Method Name is : " + nameofCurrMethod
						+ " ,An exception occured while reading the line by line in text file2: " + e.getMessage());
				Reporter.log(" Method Name is : " + nameofCurrMethod
						+ " ,An exception occured while reading the line by line in text file2: " + e.getMessage());
		...
		try {
			...
			//fileCommandsVisitor.generateHTML(resultFolder + "/" + fileTwo + ".html");
			System.out.println("hteml file is generated");
		} catch (IOException e) {
			
			String nameofCurrMethod = new Throwable().getStackTrace()[0].getMethodName();
			 TestLogger.errorMessage(" Method Name is : " + nameofCurrMethod
						+ ",An exception occured while generating difference highlighter html file : " + e.getMessage());
				Reporter.log(" Method Name is : " + nameofCurrMethod
						+ ",An exception occured while generating difference highlighter html file : " + e.getMessage());	
